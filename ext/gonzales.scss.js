...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';exports.__esModule = true;exports['default'] = moduleDef;function moduleDef(gonzalesInstance){return gonzalesInstance.registerSyntax({mark:__webpack_require__(1),parse:__webpack_require__(3),stringify:__webpack_require__(6),tokenizer:__webpack_require__(7)},'scss');}module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @param {Number} i
	 */function checkExtend1(i){var start=i;var l;if(i >= tokensLength)return 0;if(l = checkAtkeyword(i))i += l;else return 0;if(tokens[start + 1].value !== 'extend')return 0;if(l = checkSC(i))i += l;else return 0;if(l = checkCompoundSelector(i) || checkPlaceholder(i))i += l;else return 0;if(l = checkSC(i))i += l;else return 0;if(l = checkOptional(i))i += l;else return 0;return i - start;}function getExtend1(){var startPos=pos;var x=[];x.push(getAtkeyword());x = x.concat(getSC());if(checkCompoundSelector(pos))x = x.concat(getCompoundSelector());else x.push(getPlaceholder());x = x.concat(getSC());x.push(getOptional());var token=tokens[startPos];return newNode(NodeType.ExtendType,x,token.ln,token.col);} /**
	 * Checks if token is part of an extend without `!optional` flag.
	 * @param {Number} i
	 */function checkExtend2(i){var start=i;var l;if(i >= tokensLength)return 0;if(l = checkAtkeyword(i))i += l;else return 0;if(tokens[start + 1].value !== 'extend')return 0;if(l = checkSC(i))i += l;else return 0;if(l = checkCompoundSelector(i) || checkPlaceholder(i))i += l;else return 0;return i - start;}function getExtend2(){var startPos=pos;var x=[];x.push(getAtkeyword());x = x.concat(getSC());if(checkCompoundSelector(pos))x = x.concat(getCompoundSelector());else x.push(getPlaceholder());var token=tokens[startPos];return newNode(NodeType.ExtendType,x,token.ln,token.col);} /**
	 * @param {Number} i Token's index number
	 * @returns {Number}
